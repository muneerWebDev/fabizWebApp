        ...
        <div class="modal">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <label for="inv_no">Return No</label>
                ...
                <div class="form-group col-lg-4">
                    <label for="inv_no">Walk In Customer</label>
                    <input id="inv_no" type="text">
                </div>
                ...
                <div class="form-group col-lg-4">
                    ...
                    <span class="inline-input-group">
                        <input id="name" type="text">
                        <button class="btn btn-icon" title="Find Item"><i class="fa fa-search"
                        ...
                        <table class="resizable editable data-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>01</td>
                                    <td>Boss</td>
                                    <td>Lorem ipsum dolor sit amet coctetur adipicing elit. Quidem, obcaecati ex assenda
                                        conctetur</td>
                                    <td>5265</td>
                                    <td>Card</td>
                                    <td>6548</td>
                ...
                <div class="form-group col-lg-4">
                    <label for="cost">Amount Paid</label>
                    <input id="cost" type="text">
                </div>

                <div class="form-group col-lg-4">
                    <label for="cost">Balance To Return</label>
                    <input id="cost" type="text">
                </div>

                <div class="form-group col-lg-8  button-wrap">
                    <label class="custom-checkbox mr-5" for="status">Include Arabic Name In Print
