...
<main class="customer-manage-page">
    ...
    <div class="content">
        ...
        <div class="controls-wrapper">
            <a href="javaScript:void();" class="controls-btn add-new-btn" title="Add A New Supplier"><i class="fa fa-plus"
                    aria-hidden="true"></i></a>
            <a href="javaScript:void();" class="controls-btn edit-btn" title="Edit Supplier Details"><i class="fas fa-pen"></i></a>
            <a href="javaScript:void();" class="controls-btn delete-btn" title="Delete Supplier"><i class="fa fa-trash"
                    aria-hidden="true"></i></a>
        </div>
        ...
        <div class="table-wrap">
            ...
            <div class="table-responsive">
                <table class="resizable editable data-table">
                    <thead>
                        <tr>
                            <th class="filter">Customer No</th>
                            <th class="filter editable">Customer Name</th>
        ...
        <div class="modal">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label for="code">Customer No</label>
                    <input id="code" type="text">
                </div>

                <div class="form-group col-lg-6">
                    <label for="b_code">Customer Name</label>
                ...
                <div class="form-group col-lg-3">
                    <label for="vat_price">Credit Limit</label>
                    <input id="vat_price" type="text">
                </div>
