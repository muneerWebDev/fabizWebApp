...
<main class="purchases-page">
    ...
    <div class="content">
        ...
        <div class="controls-wrapper">
            <a href="javaScript:void();" class="controls-btn add-new-btn" id="add-new-btn" title="Add A New Purchase"><i
                    class="fa fa-plus" aria-hidden="true"></i></a>
            <a href="javaScript:void();" class="controls-btn edit-btn" id="edit-btn" title="Edit Purchase Details"><i
        ...
        <div class="table-wrap">
            ...
            <div class="table-responsive">
                <table class="resizable editable data-table">
                    <thead>
                        <tr>
                            <th class="filter">Purchase No</th>
        ...
        <div class="modal">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-4 offset-md-4">
                    <label for="inv_no">Supplier Inv. No</label>
                    <input id="inv_no" type="text">
                </div>
